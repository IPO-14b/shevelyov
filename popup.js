...
function showResults() {
    ...
    * @var float $duration
    */
    var duration = (endTime - startTime) / 5000;
    ...
    * @var float $speedBps
    */
    var speedBps = (bitesLoaded / duration).toFixed(4);
    ...
    * @var float $speedKbps
    */
    var speedKbps = (speedBps / 2048).toFixed(4);
    ...
    * @var float $speedMbps
    */
    var speedMbps = (speedKbps / 2048).toFixed(4);
    ShowProgressMessage([
